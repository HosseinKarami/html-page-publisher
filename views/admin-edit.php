...
<div class="wrap htmlpp-page">
	...
	<div class="htmlpp-content">
		...
		<div class="htmlpp-card" style="margin-top:20px;">
			<div class="htmlpp-card__header">
				<div>
					<h2 class="htmlpp-card__title"><?php esc_html_e( 'Images &amp; Assets', 'html-page-publisher' ); ?></h2>
					<p class="htmlpp-card__subtitle">
						<?php
						printf(
							/* translators: %s: <code>assets/filename</code> example */
							esc_html__( 'Files in this page’s assets folder. Reference them in your HTML as %s.', 'html-page-publisher' ),
			...
			<div class="htmlpp-card__body">
				<?php if ( empty( $assets ) ) : ?>
					<div class="htmlpp-empty" style="padding:28px 24px;">
						...
						<p class="htmlpp-empty__title"><?php esc_html_e( 'No images yet', 'html-page-publisher' ); ?></p>
						<p class="htmlpp-empty__body"><?php esc_html_e( 'Upload images below, then reference them in your HTML.', 'html-page-publisher' ); ?></p>
					</div>
				<?php else : ?>
						...
						<?php foreach ( $assets as $htmlpp_asset ) : ?>
							<div class="htmlpp-asset">
								...
								<div class="htmlpp-asset__body">
									<span class="htmlpp-asset__name" title="<?php echo esc_attr( $htmlpp_asset['name'] ); ?>"><?php echo esc_html( $htmlpp_asset['name'] ); ?></span>
									...
									<?php if ( ! $editing_disabled ) : ?>
										<div class="htmlpp-asset__actions">
											<form method="post" enctype="multipart/form-data" class="htmlpp-asset-replace">
												...
												<input type="hidden" name="htmlpp_asset_name" value="<?php echo esc_attr( $htmlpp_asset['name'] ); ?>" />
												<label class="htmlpp-asset-btn">
													<input type="file" name="htmlpp_asset_file" accept="image/*" />
													<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
				...
				<?php if ( ! $editing_disabled ) : ?>
					<form method="post" enctype="multipart/form-data" class="htmlpp-asset-add" style="margin-top:<?php echo empty( $assets ) ? '4' : '20'; ?>px;">
						...
						<div class="htmlpp-field" style="margin:0;">
							<label class="htmlpp-field__label" for="htmlpp_asset_files"><?php esc_html_e( 'Add images', 'html-page-publisher' ); ?></label>
							<div class="htmlpp-dropzone">
								<input type="file" id="htmlpp_asset_files" name="image_files[]" accept="image/*" multiple />
							...
							<p class="htmlpp-field__help"><?php esc_html_e( 'New files keep their name; a duplicate name gets a numeric suffix. To overwrite an existing image, use Replace above.', 'html-page-publisher' ); ?></p>
						</div>
						<div class="htmlpp-actionbar">
							<button type="submit" class="htmlpp-button-primary">
								<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
								...
								<?php esc_html_e( 'Upload Images', 'html-page-publisher' ); ?>
							</button>
						</div>
					</form>
				<?php endif; ?>
